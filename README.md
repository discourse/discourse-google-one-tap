...
For more information, please see: **url to meta topic** [refs](#refrences)
...
- Note: This plugin requires the site to use `https` otherwise it won't work. 
...
## Refrences: 
- [Google One Tap Official](https://developers.google.com/identity/gsi/web/)
